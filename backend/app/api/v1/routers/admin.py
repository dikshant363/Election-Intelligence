...
from app.identity.dependencies.auth_dependencies import require_role
from app.identity.services.rbac_service import RoleHierarchy

router = APIRouter(
    prefix="/admin",
    tags=["Enterprise Control Center"],
    dependencies=[Depends(require_role(RoleHierarchy.PLATFORM_ADMIN))],
)
